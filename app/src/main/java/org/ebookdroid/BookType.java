...
public enum BookType {
    ...
    CBR(PdfContext.class, false, true, list("cbr"), list("application/x-cbr","application/comicbook+rar")),
    ...
    DOCX(PdfContext.class, true, true, list(AppsConfig.isDOCXSupported ? "docx" : "xxx"), list("application/vnd.openxmlformats-officedocument.wordprocessingml.document")),
